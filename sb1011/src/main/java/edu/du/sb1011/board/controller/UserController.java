...
public class UserController {
    ...
    public String loginProcess(HttpServletRequest request , HttpSession session , Model model) throws UnsupportedEncodingException {
